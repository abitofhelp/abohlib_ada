...
--   ==========================================================================
   ...
   begin
      ...
      for Element of Buffer loop
         if Element /= 0 then
            return Framework_Result.Err (Abohlib.Infrastructure.Testing.Test_Framework.Test_Error'(
               Kind        => Abohlib.Infrastructure.Testing.Test_Framework.Assertion_Failed,
...
--   Different seeds should produce different data
   ...
   begin
      ...
      begin
         --  Generate zero file
         declare
            Gen_Result : constant Abohlib.Infrastructure.Testing.Test_Data.Void_Result.Result :=
               Abohlib.Infrastructure.Testing.Test_Data.Generate_Zero_File (Path, 1024);
         begin
            if not Abohlib.Infrastructure.Testing.Test_Data.Void_Result.Is_Ok (Gen_Result) then
               return Framework_Result.Err (Abohlib.Infrastructure.Testing.Test_Framework.Test_Error'(
                  Kind => Assertion_Failed,
